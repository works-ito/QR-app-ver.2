...
(function() {
  ...
  loadScript("https://cdn.jsdelivr.net/npm/zxing-wasm@3.1.3/dist/iife/reader/index.js")
    ...
    .then(function() { return loadScript("./irregular-entry-simplify-dev.js?v=74"); })
    ...
    .then(function() { return loadScript("./normal-master-entry-test-dev.js?v=7"); })
